            ...
            <header className="shrink-0 border-b border-border bg-surface/95 px-4 py-4 backdrop-blur-sm sm:px-6 lg:px-8 lg:py-5">
              <div className="flex flex-col gap-4 pr-12 lg:flex-row lg:items-center lg:justify-between lg:pr-0">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <a href={getCreateAppointmentLink(selectedCustomer)} className="inline-flex min-h-11 flex-1 items-center justify-center border border-border bg-accent px-4 font-admin-primary text-xs uppercase tracking-[0.17em] text-background transition-colors hover:bg-accent-hover sm:flex-none">+ Create Appointment</a>
